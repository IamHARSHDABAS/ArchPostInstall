...
# Install Packages
sudo pacman -Syyu
sudo pacman -S alacritty bluez bluez-utils bridge-utils brightnessctl dnsmasq feh firefox flatpak gimp git go jdk-openjdk jre-openjdk lf libguestfs libreoffice-fresh lsd maim neofetch neovim polybar qemu-base rofi rust spotify-launcher telegram-desktop unzip vde2 virt-manager virt-viewer zip
