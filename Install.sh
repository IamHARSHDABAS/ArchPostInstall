...
# Install Packages
sudo pacman -Syyu
sudo pacman -S alacritty bluez bluez-utils bridge-utils brightnessctl dnsmasq feh firefox gimp git jdk-openjdk jre-openjdk libguestfs libreoffice-fresh maim neofetch neovim polybar qemu ranger rofi spotify-launcher telegram-desktop unzip vde2 virt-manager virt-viewer zip
